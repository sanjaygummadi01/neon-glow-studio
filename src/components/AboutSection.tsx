  ...
  return (
    <section id="about" className="py-24 relative bg-glow-radial">
      <div ref={ref} className="container mx-auto px-6">
        <h2 className={`section-title text-center mb-16 scroll-reveal ${isVisible ? 'revealed' : ''}`}>About Me</h2>

        <div className={`glass-card-glow p-8 md:p-12 scroll-reveal ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.2s' }}>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className={`font-heading text-2xl font-semibold text-foreground scroll-reveal-left ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.3s' }}>
                Passionate About Design & Code
              </h3>
              <p className={`text-muted-foreground leading-relaxed scroll-reveal-left ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.4s' }}>
              ...
              <p className={`text-muted-foreground leading-relaxed scroll-reveal-left ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.5s' }}>
              ...
              <p className={`text-muted-foreground leading-relaxed scroll-reveal-left ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.6s' }}>
              ...
              <div className={`flex flex-wrap gap-8 pt-4 scroll-reveal ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.7s' }}>
            ...
            <div className={`flex justify-center scroll-reveal-right ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.4s' }}>
          ...
          <div className={`mt-12 flex justify-center scroll-reveal-scale ${isVisible ? 'revealed' : ''}`} style={{ transitionDelay: '0.8s' }}>
            <a
